...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self != nil) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(closePressed:) name:kGFColseButtonDonePressed object:nil];
...
- (CGRect)roundedRectFrame {
	...
	return CGRectMake(self.outerMargin ,
					  self.outerMargin ,
